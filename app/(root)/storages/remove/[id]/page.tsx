import CardStorageDetailsRemove from "@/components/shared/CardStorageDetailsRemove";
...
async function page({ params }: { params: { id: string } }) {
  ...
  return (
    <div>
      <h1 className="head-text text-left">About to remove:</h1>
      {storageObject.map((storageObject) =>
        storageObject.storages.map((storageArray) => (
          <div>
            <CardStorageDetailsRemove
              id={params.id}
